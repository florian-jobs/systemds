...
public class ColGroupDDCLZW extends APreAgg implements IMapToDataGroup {
    ...
    private final byte[] _dataLZW; // LZW compressed representation of the mapping
    ...
    private ColGroupDDCLZW(IColIndex colIndexes, IDictionary dict, byte[] dataLZW, int nRows, int nUnique, int[] cachedCounts) {
        super(colIndexes, dict, cachedCounts);
